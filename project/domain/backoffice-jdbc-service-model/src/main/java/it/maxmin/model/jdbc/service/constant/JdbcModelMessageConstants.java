package it.maxmin.model.jdbc.service.constant;

public enum JdbcModelMessageConstants {
	;
	...
	public static final String ERROR_STATE_CODE_NOT_NULL_MSG = "The state code must not be null";
