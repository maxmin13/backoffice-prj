...
public enum AddressQueryConstants {
	...
	public static final String SELECT_ADDRESSES_BY_USER_ID = "SELECT a.AddressId, a.Address, a.City, a.StateId, a.Region, a.PostalCode FROM Address a INNER JOIN UserAddress u ON a.AddressId = u.AddressId WHERE u.UserId = :userId ORDER BY a.addressId";
