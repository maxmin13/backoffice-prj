DELETE FROM UserAddress WHERE UserId IN (SELECT UserId FROM User WHERE AccountName = 'maxmin13');
...
DELETE FROM UserAddress WHERE UserId IN (SELECT UserId FROM User WHERE AccountName = 'artur');
