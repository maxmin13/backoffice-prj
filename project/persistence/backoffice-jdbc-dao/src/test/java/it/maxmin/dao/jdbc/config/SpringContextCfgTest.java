...
/**
 * Verifies that by loading {@link SpringContextCfg}, a {@link JdbcTemplate} and
 ...
 */
class SpringContextCfgTest {

	@Test
	void testJdbcTemplate() throws SQLException, IllegalStateException {

		var springCtx = new AnnotationConfigApplicationContext(SpringContextCfg.class);
