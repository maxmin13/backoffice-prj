...
import it.maxmin.model.jdbc.dao.exception.JdbcModelTestException;
...
class UserTest {
	...
	void getRole(String name) {
		...
		Role role1 = user.getRole("Administrator").orElseThrow(() -> new JdbcModelTestException("Error role not found"));
	...
	void getAddress(String postalCode) {
		...
		Address address1 = user.getAddress("30030")
				.orElseThrow(() -> new JdbcModelTestException("Error address not found"));
